...
con=sqlite3.connect('database221b394.db')
cur=con.cursor()
...
class bus_booking:
    ...
    def home_page(self):
        ...
        Button(root,text='Check Booked Seat',font='stylus 20 bold',bg='springgreen',command=home_to_check_booking).grid(row=5,column=2)
    ...
    def cover_page(self):
        ...
        Label(root,text='\n\n').pack()
        Label(root,text='Name : Srishti Somya',font='stylus 20 bold',fg='blue').pack()
        Label(root,text='\n').pack()
        Label(root,text='Er.no : 221b394',font='stylus 20 bold',fg='blue').pack()
        Label(root,text='\n').pack()
        Label(root,text='Number : 9399741836',font='stylus 20 bold',fg='blue').pack()
        Label(root,text='\n\n').pack()
                                            ...
                                            if len(name)>0 and len(name)<20:
                                                if age>0 and age<150:
                                                    if seats>0 and seats<6:
                                                        ...
                                                        Label(root,text="YOUR TICKET", font='Arial 12 bold').grid(row=14,columnspan=12 )
                                                        frame=Frame(root,relief="groove",bd=5)
                                                        frame.grid(row=15,columnspan=12)
                                                        
                                                        Label(frame,text="Passenger:  = " + name, font='Arial 12 bold', fg='black').grid(row=15, column=5)
                                                        Label(frame,text="Gender:  = " + gen, font='Arial 12 bold', fg='black').grid(row=15, column=6)
                                                        Label(frame,text="no of seats = " + str(seat), font='Arial 12 bold', fg='black').grid(row=16, column=5)
                                                        Label(frame,text="phone:  = " + phone, font='Arial 12 bold', fg='black').grid(row=16, column=6)
                                                        Label(frame,text="booking ref = "+b_ref,font='Arial 12 bold', fg='black').grid(row=17,column=5)
                                                        Label(frame,text="travel date = " + travel_date, font='Arial 12 bold', fg='black').grid(row=17, column=6)
                                                       
                                                      
                                                        Label(frame,text="booked on = " + book_date, font='Arial 12 bold', fg='black').grid(row=18, column=5)
                                                        Label(frame,text="age = " + str(age), font='Arial 12 bold', fg='black').grid(row=18, column=6)
                                                        Label(frame,text="fare = " + str(fare), font='Arial 12 bold', fg='black').grid(row=19, column=5)
                                                        Label(frame,text="total fare = " + str(fare*seat), font='Arial 12 bold', fg='black').grid(row=19, column=6)
    ...
    def db_add_page(self):
        ...
        home = PhotoImage(file='home.png')
        Button(root, image=home,command = to_home).grid(row=6, column=8, columnspan=2)
        root.mainloop()
